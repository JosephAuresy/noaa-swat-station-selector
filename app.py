"""
NOAA GHCND Station Selector for SWAT+
======================================
Upload any watershed shapefile, download NOAA climate stations,
filter by quality, analyze climate, and export SWAT+ ready files.
...
def run_app():
    st.set_page_config(
        page_title="NOAA Station Selector for SWAT+",
        page_icon="🌧️",
        layout="wide",
    )
